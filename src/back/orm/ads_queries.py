...
class AdsORM:
    ...
    @staticmethod
    async def select_user_ads(user_id: int) -> list[AdFromDB] | None:
        async with db.create_async_session() as session:
    ...
    @staticmethod
    async def select_favorite_list(user_id: int) -> list[AdFromDB] | None:
        async with db.create_async_session() as session:
    ...
    @staticmethod
    async def select_ad_by_id(ad_id: int) -> list[AdFromDB] | None:
        async with db.create_async_session() as session:
